...
export const VERTICAL_CONFIGS: Record<VerticalID, VerticalConfig> = {
  ...
  HEALTH_EDU: { 
    id: 'HEALTH_EDU', 
    label: 'Health & Edu', 
    theme: { primaryColor: '#06b6d4', secondaryColor: '#cffafe' }, 
    enabledComponents: ['symptom-triage', 'lesson-tracker', 'service-quote'], 
    collections: ['patients', 'courses', 'appointments'] 
  },
  SOCIAL: { 
    id: 'SOCIAL', 
    label: 'Social & Media', 
    theme: { primaryColor: '#db2777', secondaryColor: '#fce7f3' }, 
    enabledComponents: ['mini-video', 'game-scoreboard'], 
    collections: ['posts', 'users', 'events'] 
  },
  GOVTECH: { 
    id: 'GOVTECH', 
    label: 'GovTech', 
    theme: { primaryColor: '#57534e', secondaryColor: '#f5f5f4' }, 
    enabledComponents: ['permit-app', 'issue-reporter', 'tax-summary'], 
    collections: ['permits', 'reports', 'citizens'] 
  },
  REAL_ESTATE: { 
    id: 'REAL_ESTATE', 
    label: 'Real Estate', 
    theme: { primaryColor: '#8b5cf6', secondaryColor: '#f3e8ff' }, 
    enabledComponents: ['property-listing', 'maintenance-req'], 
    collections: ['properties', 'leases', 'requests'] 
  },
  AUTOMOTIVE: { 
    id: 'AUTOMOTIVE', 
    label: 'Automotive', 
    theme: { primaryColor: '#ef4444', secondaryColor: '#fee2e2' }, 
    enabledComponents: ['ev-status', 'vehicle-remote', 'toll-pass'], 
    collections: ['vehicles', 'charging_stations', 'trips'] 
  },
  PROFESSIONAL: { 
    id: 'PROFESSIONAL', 
    label: 'Professional', 
    theme: { primaryColor: '#0f172a', secondaryColor: '#f1f5f9' }, 
    enabledComponents: ['freelancer-card', 'consultation-timer', 'doc-scanner'], 
    collections: ['projects', 'invoices', 'contracts'] 
  },
  UTILITIES: { 
    id: 'UTILITIES', 
    label: 'Utilities', 
    theme: { primaryColor: '#eab308', secondaryColor: '#fefce8' }, 
    enabledComponents: ['energy-graph', 'bill-pay', 'outage-map'], 
    collections: ['meters', 'bills', 'outages'] 
  },
  TRAVEL: { 
    id: 'TRAVEL', 
    label: 'Travel', 
    theme: { primaryColor: '#0ea5e9', secondaryColor: '#e0f2fe' }, 
    enabledComponents: ['boarding-pass', 'hotel-concierge', 'currency-converter'], 
    collections: ['flights', 'hotels', 'itineraries'] 
  },
};
