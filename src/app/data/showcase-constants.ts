...
export const MOCK_ARTIFACT_DATA: Record<string, any> = {
  ...
  'payroll-run': {
    ...
    metrics: [
      { label: "Total Cost", value: "$4.2M", change: "+2%" },
      { label: "Headcount", value: "1,240", change: "+12" },
      { label: "Status", value: "Approved", change: "On Time" }
    ]
  },
  ...
  'production-recipe': {
    tasks: [
      { id: "s1", text: "Casting Phase (Aluminum)", done: true },
      { id: "s2", text: "CNC Machining", done: true },
      { id: "s3", text: "Laser Honing", done: false },
      { id: "s4", text: "Final Cleaning", done: false }
    ]
  },
  'project-gantt': {
    jobs: [
      { id: "SCENE-01", product: "Scene 1: Intro", start: 0, duration: 40, status: "completed" },
      { id: "SCENE-02", product: "Scene 2: Chase", start: 45, duration: 30, status: "running" },
      { id: "SCENE-03", product: "Scene 3: Finale", start: 80, duration: 20, status: "scheduled" }
    ],
    conflicts: 0
  },
  'oee-dashboard': {
  ...
  'yield-grading': { 
    ...
    yield: "98%", 
    defects: 2, 
    inspector: "AI-Vision-01",
    sampleImage: "https://images.unsplash.com/photo-1615347497551-277d6616b959?auto=format&fit=crop&q=80&w=200"
  },
  'geological-survey': {
    zones: [
      { id: "s1", name: "Sector 1 (Surface)", score: 15, trend: "stable" },
      { id: "s2", name: "Sector 2 (Deep)", score: 85, trend: "up" },
      { id: "s3", name: "Sector 3 (Core)", score: 40, trend: "down" }
    ]
  },
  ...
  'traffic-monitor': {
    zones: [
      { id: "downtown", name: "Downtown Core", score: 95, trend: "up" },
      { id: "highway", name: "M1 Highway", score: 45, trend: "stable" },
      { id: "subs", name: "Suburbs", score: 20, trend: "down" }
    ]
  },
  'symptom-triage': {
  ...
  // --- PLATFORM / SYSTEM LEVEL (The Kernel) ---
  'control-plane-console': {
    title: "System Health",
    metrics: [
      { label: "Active Tenants", value: "142", change: "+5" },
      { label: "CPU Load", value: "45%", change: "-2%" },
      { label: "Deployments", value: "450", change: "Stable" }
    ]
  },
  'ai-inference-log': {
    tasks: [
      { id: "1", text: "Book Ride (MP-01) [98%]", done: true },
      { id: "2", text: "Detect Fraud (MP-05) [95%]", done: true },
      { id: "3", text: "Route Opt (MP-04) [Pending]", done: false }
    ]
  },
  'security-audit-log': {
    tasks: [
      { id: "1", text: "Block IP 192.168.1.55", done: true },
      { id: "2", text: "Quarantine HR-Server-01", done: true },
      { id: "3", text: "Analyze Packet Dump", done: false }
    ]
  },
  'config-rollout-tracker': {
    ...
    currentXP: 850,
    nextLevelXP: 1000,
    badges: [{ name: "Canary Passed", earned: true }, { name: "Load Test", earned: true }],
    activeMissions: [{ name: "Deploy to MENA", progress: 85, total: 100 }]
  },
  ...
  'credential-verification': { 
    filename: "Degree_Verification_Ahmed.pdf",
    size: "120KB",
    signed: true,
    id: "CERT-9921", 
    holder: "Ahmed Al-Farsi", 
    type: "Degree" 
  },
  ...
  'maintenance-req': { id: "MNT-882", title: "Leaking Pipe", location: "Unit 402", priority: "High", reportedBy: "Tenant", status: "Assigned" },
  ...
  // --- Utilities ---
  'energy-graph': { daily: [12, 15, 18, 14, 20, 16, 12], monthly: [450, 420, 480, 500] },
  'bill-pay': { provider: 'Electric Co', amount: '$120.50', due: '2025-01-15' },
  'outage-map': { outages: 3, affected: 120, estimatedFix: '2h 30m' },
  'smart-grid-load-balancer': { totalLoad: "450 MW", capacity: "600 MW", zones: [{ id: "Z1", load: 85 }, { id: "Z2", load: 45 }] },
  ...
  'harvest-log': { crop: "Wheat", yield: "4.5 tons", field: "A4", date: "Yesterday" },
  ...
  'game-scoreboard': { match: "Team Liquid vs. T1", score: "2 - 1", game: 3, time: "24:15", goldDiff: "+2.5k" },
  ...
  'property-market-heatmap': {
    zones: [
      { id: "Downtown", value: 100, label: "High Demand" },
      { id: "Suburbs", value: 65, label: "Stable" },
      { id: "Industrial", value: 40, label: "Growing" }
    ]
  },

  // --- Domain 12-19 Expansion ---
  'learning-progress-tracker': { activeCourses: 4, completed: 12, averageGrade: "A-", nextClass: "Biology 101" },
  'live-auction-bidding': { item: "Vintage Watch", currentBid: "$450", bidder: "User_99", timeLeft: "00:45" },
  'work-order-dispatcher': { pending: 5, active: 2, completed: 18, urgent: "Leak at 4B" },
  'vehicle-marketplace-listing': { make: "Toyota", model: "Camry", year: 2022, price: "$24,500", condition: "Certified" },
  'smart-home-hub': { lights: "On", temp: "22C", security: "Armed", camera: "Active" },
  'incident-command-map': { activeIncidents: 3, unitsDispatched: 5, severity: "Medium", zone: "Downtown" },
  'fediverse-feed': { posts: 150, followers: 2400, server: "dakkah.social", status: "Online" },
  'neighborhood-pulse': { crowdLevel: "Medium", events: 2, alerts: "None", trend: "Quiet" },
  'virtual-classroom': { participants: 24, engagement: "High", topic: "Calculus II", recording: "On" },
  'ehr-patient-record': { patientId: "P-9982", alerts: "Penicillin Allergy", lastVisit: "2025-10-12", status: "Stable" },
  'vod-creator-studio': { subscribers: "12.5k", views: "45k", revenue: "$850", latestVideo: "City Tour" },
  ...
  'clinical-decision-support': { 
    message: "Recommendation: Increase Lisinopril to 20mg for Hypertension.",
    type: "info",
    time: "Just now",
    details: "Evidence: JNC 8 Guidelines"
  },
  'experiment-designer': { protocol: "PCR Amplification", step: 3, totalSteps: 12, status: "Active" },
  'research-paper': { title: "Impact of AI on Logistics", abstract: "A study on algorithmic efficiency...", authors: ["Dr. Smith"], version: 1.0 },
  ...
  'global-supply-tower': {
    zones: [
      { id: "na", name: "North America", score: 92, trend: "stable" },
      { id: "emea", name: "EMEA", score: 85, trend: "down" },
      { id: "apac", name: "APAC", score: 98, trend: "up" }
    ]
  },
  'marketplace-pulse': {
    title: "Commerce Engine",
    metrics: [
      { label: "GMV / hr", value: "$1.2M", change: "+5%" },
      { label: "Active Sessions", value: "45k", change: "+12%" },
      { label: "Conversion", value: "2.4%", change: "-0.5%" }
    ]
  },
  'crowd-control-system': {
    zones: [
      { id: "n-stand", name: "North Stand", score: 95, trend: "up" },
      { id: "s-stand", name: "South Stand", score: 60, trend: "stable" },
      { id: "vip", name: "VIP Box", score: 20, trend: "stable" }
    ]
  },
  'border-flow-analyzer': {
    title: "Border Throughput",
    metrics: [
      { label: "Arrivals/hr", value: "12.5k", change: "+8%" },
      { label: "Visa Process", value: "45s", change: "-10%" },
      { label: "Flagged", value: "2", change: "0%" }
    ]
  },
  'cdn-distribution-node': {
    title: "Edge Network",
    metrics: [
      { label: "Bandwidth", value: "450Gbps", change: "+25%" },
      { label: "Cache Hit", value: "98.5%", change: "+0.1%" },
  ...
  'liquidity-ledger': {
    ...
    metrics: [
      { label: "Reserve Ratio", value: "115%", change: "+1%" },
      { label: "24h Volume", value: "4.5B", change: "+3%" },
      { label: "Fraud Alerts", value: "0", change: "0%" }
    ]
  },
  'epidemic-surveillance': {
    zones: [
      { id: "central", name: "Central District", score: 15, trend: "stable" },
      { id: "north", name: "North District", score: 45, trend: "up" },
      { id: "airport", name: "Airport Zone", score: 80, trend: "up" }
    ]
  }
};
