...
export const ARTIFACT_DOCS: Record<string, ArtifactDoc> = {
  ...
  'property-market-heatmap': {
    description: "Real-time valuation and demand tracking for real estate.",
    useCase: "Market analysis for investors and city planners.",
    personas: ["Urban Planner", "Real Estate Agent"],
    dataPoints: ["Price/SqM", "Vacancy Rate", "Demand Index"],
    technical: "Heatmap Overlay",
    actions: ["Filter Zone", "View Trend"]
  },
  
  // --- Domain 12-19 Expansion (Aligned with City-OS Master Tree) ---
  'learning-progress-tracker': {
    description: "Student progress and course management (LMS/SIS).",
    useCase: "Tracking grades, attendance, and assignments.",
    personas: ["Teacher", "Student", "Admin"],
    dataPoints: ["GPA", "Completion %", "Attendance"],
    technical: "Moodle + Learning Locker (xAPI)",
    actions: ["Grade", "Enroll", "View Transcript"]
  },
  'virtual-classroom': {
    description: "Live interactive learning session.",
    useCase: "Remote lectures and breakout groups.",
    personas: ["Teacher", "Student"],
    dataPoints: ["Participants", "Engagement Score"],
    technical: "BigBlueButton / Jitsi",
    actions: ["Raise Hand", "Share Screen", "Record"]
  },
  'live-auction-bidding': {
    description: "Real-time bidding engine for auctions.",
    useCase: "Managing bids for high-value assets.",
    personas: ["Bidder", "Auctioneer"],
    dataPoints: ["Current Bid", "Time Left", "Reserve Met"],
    technical: "Odoo Auction Module",
    actions: ["Place Bid", "Watch", "Auto-Bid"]
  },
  'work-order-dispatcher': {
    description: "Maintenance job tracking and dispatch.",
    useCase: "Assigning crews to repair tasks.",
    personas: ["Facility Manager", "Technician"],
    dataPoints: ["Status", "Priority", "Location"],
    technical: "OpenMAINT + ERPNext",
    actions: ["Dispatch", "Complete", "Order Parts"]
  },
  'vehicle-marketplace-listing': {
    description: "Car sales and fleet inventory.",
    useCase: "Buying/selling vehicles or managing fleet.",
    personas: ["Dealer", "Buyer", "Fleet Mgr"],
    dataPoints: ["Price", "Mileage", "Condition"],
    technical: "ERPNext Fleet + PayloadCMS",
    actions: ["Contact", "Book Test Drive", "Make Offer"]
  },
  'smart-home-hub': {
    description: "Central control for home IoT devices.",
    useCase: "Managing lights, security, and climate.",
    personas: ["Homeowner"],
    dataPoints: ["State", "Battery", "Signal"],
    technical: "Home Assistant + Mosquitto",
    actions: ["Toggle", "Set Scene", "View Camera"]
  },
  'incident-command-map': {
    description: "Public safety situational awareness.",
    useCase: "Coordinating emergency response units.",
    personas: ["Dispatcher", "First Responder"],
    dataPoints: ["Severity", "Units", "Casualties"],
    technical: "Sahana Eden + Novu Alerts",
    actions: ["Dispatch", "Escalate", "Broadcast Alert"]
  },
  'fediverse-feed': {
    description: "Decentralized social media timeline.",
    useCase: "Viewing posts from the federated network.",
    personas: ["User", "Moderator"],
    dataPoints: ["Posts", "Boosts", "Likes"],
    technical: "Mastodon (ActivityPub) + Matrix",
    actions: ["Post", "Reply", "Follow", "Moderate"]
  },
  'neighborhood-pulse': {
    description: "Hyperlocal activity and signal tracking.",
    useCase: "Monitoring zone-level events and density.",
    personas: ["Resident", "City Planner"],
    dataPoints: ["Crowd Density", "Event Count"],
    technical: "PostGIS + Discourse + PayloadCMS",
    actions: ["Check-in", "Report", "View Trends"]
  },
  'ehr-patient-record': {
    description: "Comprehensive clinical patient history.",
    useCase: "Doctors reviewing history during consult.",
    personas: ["Doctor", "Nurse"],
    dataPoints: ["Vitals", "History", "Meds"],
    technical: "OpenEMR / OpenMRS",
    actions: ["Prescribe", "Add Note", "Order Lab"]
  },
  'vod-creator-studio': {
    description: "Video upload and channel management.",
    useCase: "Creators managing their content library.",
    personas: ["Creator", "Producer"],
    dataPoints: ["Views", "Subscribers", "Revenue"],
    technical: "PeerTube + MediaMTX",
    actions: ["Upload", "Go Live", "Analyze Stats"]
  },
  ...
  'game-scoreboard': {
    description: "Live match stats for esports competitions.",
    useCase: "Broadcasting tournament updates.",
    personas: ["Fan", "Caster"],
    dataPoints: ["Score", "Game Timer", "Gold Diff"],
    technical: "Live Data Stream",
    actions: ["View Stats", "Watch Stream", "Bet"]
  },
  'asset-tracker': {
    description: "Location and status tracking for high-value items.",
    useCase: "Managing enterprise laptops or media equipment.",
    personas: ["IT Admin", "Production Mgr"],
    dataPoints: ["Location", "User", "Status"],
    technical: "RFID / GPS",
    actions: ["Check In", "Report Lost", "View History"]
  },
  'project-gantt': {
    description: "Timeline view for creative projects.",
    useCase: "Managing film production schedules.",
    personas: ["Producer", "Director"],
    dataPoints: ["Task", "Duration", "Dependencies"],
    technical: "Gantt Chart",
    actions: ["Move Task", "Assign Crew", "Export"]
  },
  'harvest-log': {
    description: "Record of agricultural yield data.",
    useCase: "Tracking crop output by field.",
    personas: ["Farmer"],
    dataPoints: ["Crop Type", "Weight", "Field ID"],
    technical: "Data Entry",
    actions: ["Log Yield", "Compare Years", "Export"]
  },
  'outage-map': {
    description: "Geospatial view of service interruptions.",
    useCase: "Communicating grid status to customers.",
    personas: ["Public", "Dispatcher"],
    dataPoints: ["Affected Area", "ETA"],
    technical: "Map Overlay",
    actions: ["Report Outage", "Check Status", "Subscribe"]
  },

  // --- Gap Fillers (Mega-Process Completions) ---
  'credential-verification': {
    description: "Digital verification of academic or professional credentials.",
    useCase: "Employers verifying candidate degrees.",
    personas: ["Recruiter", "University Admin"],
    dataPoints: ["Issuer", "Date", "Status"],
    technical: "Blockchain / Verifiable Credential",
    actions: ["Verify", "Download Cert", "Share"]
  },
  'clinical-decision-support': {
    description: "AI-assisted diagnostic and treatment recommendations.",
    useCase: "Doctors reviewing patient charts for best practices.",
    personas: ["Physician"],
    dataPoints: ["Recommendation", "Risk Level", "Evidence"],
    technical: "Rule Engine / AI",
    actions: ["Accept", "Modify", "Dismiss"]
  },
  'maintenance-req': {
    description: "Ticket for facility repairs or service.",
    useCase: "Tenants reporting issues in their building.",
    personas: ["Tenant", "Facility Mgr"],
    dataPoints: ["Priority", "Location", "Status"],
    technical: "Ticketing System",
    actions: ["Assign", "Update Status", "Close"]
  },
  'geological-survey': {
    description: "Analysis of soil and rock composition for extraction.",
    useCase: "Mining companies planning new sites.",
    personas: ["Geologist"],
    dataPoints: ["Mineral Concentration", "Depth"],
    technical: "3D Spatial Data",
    actions: ["View Core Sample", "Map Layer", "Export"]
  },
  'yield-grading': {
    description: "Quality classification of raw materials or harvest.",
    useCase: "Sorting mined ore or agricultural produce.",
    personas: ["Quality Inspector"],
    dataPoints: ["Grade", "Purity", "Defects"],
    technical: "Computer Vision",
    actions: ["Re-grade", "Reject", "Approve"]
  },
  'production-recipe': {
    description: "Step-by-step manufacturing instructions.",
    useCase: "Factory machines executing a build process.",
    personas: ["Process Engineer"],
    dataPoints: ["Materials", "Steps", "Params"],
    technical: "Recipe Management",
    actions: ["Load to Machine", "Edit", "Version Control"]
  },
  'payroll-run': {
    description: "Execution of bulk salary and wage payments.",
    useCase: "HR processing monthly payroll.",
    personas: ["Payroll Admin"],
    dataPoints: ["Total Cost", "Employee Count", "Status"],
    technical: "Batch Processing",
    actions: ["Approve Run", "View Slips", "Hold"]
  },
  'traffic-monitor': {
    description: "Real-time road network congestion tracking.",
    useCase: "City managers optimizing traffic flow.",
    personas: ["Traffic Controller"],
    dataPoints: ["Congestion Level", "Incident Count"],
    technical: "IoT / Camera Feed",
    actions: ["Adjust Signal", "Dispatch Police", "Alert Public"]
  },

  // --- Dakkah Platform Kernel (System Views) ---
  'control-plane-console': {
    description: "Central administration dashboard for the Dakkah OS.",
    useCase: "Monitoring tenant health and global system status.",
    personas: ["Platform Engineer", "COO"],
    dataPoints: ["Tenant Count", "System Load", "Deployment Queue"],
    technical: "Admin Dashboard",
    actions: ["Provision Tenant", "Restart Service", "View Logs"]
  },
  'ai-inference-log': {
    description: "Real-time stream of AI decision-making events.",
    useCase: "Debugging agent intent classification and actions.",
    personas: ["AI Lead", "Data Scientist"],
    dataPoints: ["Intent Confidence", "Latency", "Action Triggered"],
    technical: "Log Stream",
    actions: ["Retrain", "Flag Error", "Trace Request"]
  },
  'security-audit-log': {
    description: "Immutable ledger of access and security events.",
    useCase: "Compliance auditing and threat detection (MP-05).",
    personas: ["CISO", "Security Analyst"],
    dataPoints: ["Auth Events", "Blocked IPs", "Risk Score"],
    technical: "SIEM Dashboard",
    actions: ["Lock Account", "Whitelist IP", "Export Audit"]
  },
  'config-rollout-tracker': {
    description: "Visualization of configuration propagation across edge nodes.",
    useCase: "Managing global feature flags and regional settings (MP-06).",
    personas: ["Engineering Director"],
    dataPoints: ["Propagation %", "Region Status", "Version"],
    technical: "Progress Map",
    actions: ["Rollback", "Pause", "Force Sync"]
  },

  // --- Dakkah Vertical Kernels (The 10-Vertical "God View") ---
  'global-supply-tower': {
    description: "Control tower for global logistics and freight movement.",
    useCase: "Monitoring international supply chain flow (Logistics 01).",
    personas: ["Supply Chain VP", "Logistics Commander"],
    dataPoints: ["Fleet Status", "Volume TEU", "Delays"],
    technical: "Geospatial Dashboard",
    actions: ["Reroute", "Prioritize", "Lockdown"]
  },
  'marketplace-pulse': {
    description: "Real-time economic activity monitor.",
    useCase: "Tracking GMV and transaction health (Commerce 02).",
    personas: ["Marketplace Head", "Economist"],
    dataPoints: ["GMV", "Conversion Rate", "Active Users"],
    technical: "Live Metrics Deck",
    actions: ["Boost Category", "Flash Sale", "Throttle"]
  },
  'crowd-control-system': {
    description: "Density and flow monitoring for mass gatherings.",
    useCase: "Managing stadium or conference safety (Events 04).",
    personas: ["Safety Officer", "Event Director"],
    dataPoints: ["Headcount", "Density Heatmap", "Ingress Rate"],
    technical: "Heatmap / Sensor Grid",
    actions: ["Open Gate", "Deploy Security", "Evacuate"]
  },
  'border-flow-analyzer': {
    description: "Immigration and tourism flow analytics.",
    useCase: "Optimizing visa processing and airport throughput (Tourism 05).",
    personas: ["Border Control", "Tourism Board"],
    dataPoints: ["Arrivals/Hour", "Visa Time", "Nationality Mix"],
    technical: "Flow Sankey",
    actions: ["Open Counters", "Flag Pattern", "Report"]
  },
  'cdn-distribution-node': {
    description: "Edge network status for media delivery.",
    useCase: "Ensuring streaming quality during major events (Media 06).",
    personas: ["Network Engineer", "Media Ops"],
    dataPoints: ["Bandwidth", "Cache Hit %", "Latency"],
    technical: "Network Graph",
    actions: ["Purge Cache", "Reroute Traffic", "Scale Up"]
  },
  'liquidity-ledger': {
    description: "Central bank style view of system liquidity.",
    useCase: "Monitoring financial stability and reserves (Payments 07).",
    personas: ["CFO", "Treasury Head"],
    dataPoints: ["Reserve Ratio", "Volume", "Float"],
    technical: "Financial Ledger",
    actions: ["Inject Liquidity", "Audit", "Freeze"]
  },
  'epidemic-surveillance': {
    description: "Population-level health signal detection.",
    useCase: "Early warning system for outbreaks (Health 08).",
    personas: ["Chief Medical Officer", "Health Minister"],
    dataPoints: ["Symptom Rate", "ICU Beds", "R-Number"],
    technical: "Geo-Health Map",
    actions: ["Alert Region", "Mobilize Resources", "Quarantine"]
  }
};
